            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 sm:p-10">
                ...
                <form action="{{ route('categories.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" required class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-red-200 focus:border-red-500 outline-none transition" placeholder="Contoh: Makanan, Minuman, Es...">
                    </div>
