...
<head>
    ...
    <title>Reset Password - Penyetan Pwedespoll</title>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
        <div class="w-full max-w-md">
            <div class="mb-10">
                ...
                <p class="text-gray-500">Silakan masukkan email dan password baru Anda.</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="password" name="password" required 
                        class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-red-600 focus:border-transparent outline-none transition-all" placeholder="Minimal 8 karakter">
                ...
                <div>
                    ...
                    <input type="password" name="password_confirmation" required 
                        class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-red-600 focus:border-transparent outline-none transition-all" placeholder="Ketik ulang password baru">
                </div>
