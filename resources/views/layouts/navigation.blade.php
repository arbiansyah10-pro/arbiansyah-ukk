        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="font-bold text-xl text-red-600 flex items-center gap-2">
                        <span>🌶️</span> Admin
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Ini Menu Kategori yang baru ditambahkan -->
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <a href="{{ url('/') }}" target="_blank" class="text-sm font-medium text-gray-500 hover:text-red-600 mr-4 flex items-center gap-1 transition">
                    🌐 Lihat Web
                </a>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden shadow-inner bg-gray-50">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link href="{{ url('/') }}" target="_blank" class="text-blue-600 font-medium">
                    🌐 Lihat Halaman Web
                </x-responsive-nav-link>
